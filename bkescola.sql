...
INSERT INTO `tbldisciplina` VALUES (_binary 'Fè\∆.m1Èóë–îf€ä\Ô','Banco de Dados 2','2019-05-02 20:23:08',NULL,2,'BD2A3');
...
INSERT INTO `tbldocente` VALUES (_binary '\—\…Uz}±\Èµ\⁄–îf€ä\Ô','2019-05-23 20:23:49',NULL,1,'0000001','Jo√£ozinho','MESTRADO','1980-12-13');
...
INSERT INTO `tblestudante` VALUES (_binary 'hp?g˙Ç\"\‰\—\"f\Í?ã',1,'2019-04-25 21:08:24','2019-05-23 20:05:18','3013146','Vinicius Eustaquio Cortez','1999-11-28');
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `prAtualizarDisciplina`(varSiglaAtual char(5), varSiglaNova char(5), varNome varchar(50))
BEGIN
START TRANSACTION;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `prAtualizarDocente`( varProntuario char(7), varNome varchar(50), varNascimento date, 
...
-- Dump completed on 2019-05-23 22:04:28
